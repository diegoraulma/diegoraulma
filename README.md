...
## 🚀 About Me 
I am a Systems Engineering student (Top 10%) split between the **Universidad de Lima** and **Tecnológico de Monterrey**, deeply passionate about Data Science, Machine Learning, and Digital Transformation. 

My background combines solid technical skills in predictive modeling and computer vision with hands-on corporate experience. As a former QA Intern at **NTT DATA**, I helped optimize processes (reducing report logging times by 40%) and ensured data pipeline quality using Azure Data Factory and SQL Server.
...
* **📊 Sales Channel Optimization (BCP | DataFest 2025):** Built propensity models and optimal lead allocation algorithms to maximize conversion rates for Peru's largest bank.
* **📞 Call Center Demand Forecasting (Universidad de Lima, 2025):** Implemented time-series models combined with XGBoost to predict incoming call volumes, optimizing staffing using MAPE metrics.
...
#### 🗄️ Cloud, Data & Automation
<p>
  <img src="https://img.shields.io/badge/SQL_Advanced-4479A1?style=flat&logo=microsoft-sql-server&logoColor=white" alt="SQL">
  <img src="https://img.shields.io/badge/Microsoft_Azure-0089D6?style=flat&logo=microsoft-azure&logoColor=white" alt="Azure">
  <img src="https://img.shields.io/badge/PySpark_Basic-E25A1C?style=flat&logo=apache-spark&logoColor=white" alt="PySpark">
  <img src="https://img.shields.io/badge/Power_Automate-2575ED?style=flat&logo=microsoft-power-automate&logoColor=white" alt="Power Automate">
</p>

#### 📊 Business Intelligence & Frameworks
<p>
  <img src="https://img.shields.io/badge/Power_BI_Advanced-F2C811?style=flat&logo=powerbi&logoColor=black" alt="Power BI">
...
* **Mining 4.0:** Exploring Industrial AI applications and innovation frameworks (INARQ 2026 specialization).
